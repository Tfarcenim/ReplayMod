...
public class MCVer {
    ...
    public static void setDetail(CrashReportCategory category, String name, Callable<String> callable) {
    ...
    public static int getMouseX(ScreenEvent.DrawScreenEvent.Post event) {
